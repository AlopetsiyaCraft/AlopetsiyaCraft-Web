...
/**
 * 3D-карта мира (BlueMap) на главной странице — встроена сразу, без баннера.
 * Прокрутка страницы «дёргалась» не из-за карты, а из-за чата
 * (scrollIntoView вытаскивал чат обратно в экран каждые 500мс) — это
 * починено в LiveChat. Здесь iframe без lazy-загрузки, чтобы появление
 * фрейма во вьюпорте не давало скачков, и без внутреннего скролла.
